...
def test_case_1():
    ...
    # Get case 1
    test_case = test_data['data']['1']
    sentence = test_case['sentence']
    expected = test_case['expected']
    
    print(f"Testing case 1: {sentence}")
    print(f"Expected:")
...
def test_case_2():
    ...
    # Get case 2
    test_case = test_data['data']['2']
    sentence = test_case['sentence']
    expected = test_case['expected']
    
    print(f"Testing case 2: {sentence}")
    print(f"Expected:")
    print(f"  Main slots: {expected['main_slots']}")
    print(f"  Sub-slots: {expected['sub_slots']}")
