...
# -*- coding: utf-8 -*-
"""
実データでのAbsoluteOrderManager検証結果をファイル出力
"""
...
def test_real_data_groups_to_file():
    """実データのtellグループと基本副詞グループで検証し、結果をファイル出力"""
    
    # 出力ファイルを準備
    output_file = "absolute_order_verification_results.txt"
    
    with open(output_file, "w", encoding="utf-8") as f:
        # ヘッダー情報
        f.write("=" * 80 + "\n")
        f.write("AbsoluteOrderManager 実データ検証結果\n")
...
if __name__ == "__main__":
    output_file = test_real_data_groups_to_file()
