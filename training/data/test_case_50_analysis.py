...
def calculate_accuracy(expected, actual):
    ...
    # Check main slots
    for slot in ['S', 'V', 'O1', 'O2', 'C1', 'C2', 'M1', 'M2', 'Aux']:
        total_slots += 1
    ...
    # Check sub slots
    for slot in ['sub-s', 'sub-v', 'sub-o1', 'sub-o2', 'sub-c1', 'sub-c2', 'sub-m1', 'sub-m2', 'sub-m3', 'sub-aux']:
        total_slots += 1
...
def test_case_50():
    ...
    # Get case 50
    test_case = test_data['data']['50']
    sentence = test_case['sentence']
    expected = test_case['expected']
    
    print(f"Testing case 50: {sentence}")
    print(f"Expected:")
